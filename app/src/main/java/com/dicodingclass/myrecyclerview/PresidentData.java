package com.dicodingclass.myrecyclerview;
...
public class PresidentData {
    public static String[][] data = new String[][]{
            ...
            {"Fujiatma ", "Presiden Kedelapan RI", "https://i1.rgstatic.net/ii/profile.image/723961360969729-1549617247099_Q512/Fujiatma_Napitupulu.jpg"},
    };
